window.NEWS_ARCHIVE = [
  ...
  },
  {
    ...
    "title": "Korea News Brief",
    "primarySource": "https://world.kbs.co.kr/service/news_main.htm?lang=e",
    "summary": "Today’s Korea news covers Economy, Korea, Science, Domestic, International. This free edition uses public news feeds, so it updates without paid API credits.",
    "stories": [
      {
        "category": "Economy",
        "source": "The Korea Times",
        "title": "Poongsan decides not to sell ammunition business: FKI chief",
        "url": "https://www.koreatimes.co.kr/business/companies/20260720/poongsan-decides-not-to-sell-ammunition-business-fki-chief?utm_source=rss",
        "summary": "JEJU ISLAND — Poongsan Group has decided not to sell its high-profile ammunition business, Federation of Korean Industries (FKI) Chairman Ryu Jin said Friday, dismissing persistent speculation that the defense unit could be put on the market as rising global demand boosts the company's earnings. Ryu, who also serves as chairman of Poongsan Group, said the company had previously explored the potential value of the business, but decided to retain it because of its strong profitability. \"Poongsan's defense business is performing well, so we had discussed what it might be worth,\" Ryu told reporters during a press conference on the sidelines of the FKI CEO Summer Forum. \"However, we have decided not to sell it for now.\" Instead of divesting the ammunition business, Ryu said Poongsan plans to use the profits generated by its defense operations to pursue new service-sector investments for revit...",
        "fullText": [
          "JEJU ISLAND — Poongsan Group has decided not to sell its high-profile ammunition business, Federation of Korean Industries (FKI) Chairman Ryu Jin said Friday, dismissing persistent speculation that the defense unit could be put on the market as rising global demand boosts the company's earnings. Ryu, who also serves as chairman of Poongsan Group, said the company had previously explored the potential value of the business, but decided to retain it because of its strong profitability.",
          "\"Poongsan's defense business is performing well, so we had discussed what it might be worth,\" Ryu told reporters during a press conference on the sidelines of the FKI CEO Summer Forum. \"However, we have decided not to sell it for now.",
          "\" Instead of divesting the ammunition business, Ryu said Poongsan plans to use the profits generated by its defense operations to pursue new service-sector investments for revit..."
        ],
        "words": [
          "poongsan",
          "decides",
      ...
      },
      {
        "category": "Korea",
        "source": "The Korea Times",
        "title": "BTS lights up World Cup stage with Madonna, Shakira, Justin Bieber",
        "url": "https://www.koreatimes.co.kr/sports/20260720/bts-lights-up-world-cup-stage-with-madonna-shakira-justin-bieber?utm_source=rss",
        "summary": "Born in Korea, now playing at the World Cup. Korean stars BTS, alongside Madonna, Justin Bieber, and Shakira each brought a bit of one of their hits to the World Cup's first halftime show in a whirlwind performance Sunday that also squeezed in Burna Boy, Ted Lasso and many Muppets. The show at what's otherwise known as MetLife Stadium, outside New York, was an attempt to bring Super Bowl vibes to the World Cup, but the 11-minute performance was considerably more packed than the usual one-headliner, 13-minute American football counterpart. Each headliner here spent about two minutes performing. Madonna opened the show with her 2000 dance-pop hit “Music,” joined by star Brazilian soccer players of yesteryear, Ronaldo and Ronaldinho. It started with an apparently prerecorded piece in a roller rink before she rode into the stadium on a dune buggy, singing, “Music, makes the people come toget...",
        "fullText": [
          "Born in Korea, now playing at the World Cup. Korean stars BTS, alongside Madonna, Justin Bieber, and Shakira each brought a bit of one of their hits to the World Cup's first halftime show in a whirlwind performance Sunday that also squeezed in Burna Boy, Ted Lasso and many Muppets.",
          ...
          "Madonna opened the show with her 2000 dance-pop hit “Music,” joined by star Brazilian soccer players of yesteryear, Ronaldo and Ronaldinho. It started with an apparently prerecorded piece in a roller rink before she rode into the stadium on a dune buggy, singing, “Music, makes the people come toget..."
        ],
        "words": [
          "lights",
          "madonna",
      ...
      },
      {
        "category": "Korea",
        "source": "The Korea Times",
        "title": "The World Cup final is here, with Argentina taking on Spain in soccer's biggest game",
        "url": "https://www.koreatimes.co.kr/sports/20260720/the-world-cup-final-is-here-with-argentina-taking-on-spain-in-soccers-biggest-game?utm_source=rss",
        "summary": "EAST RUTHERFORD, N.J. — Lionel Messi and Argentina on one side. Lamine Yamal and Spain on the other. The World Cup final is finally here. Kickoff is at 3 p.m. EDT at MetLife Stadium. Argentina is seeking its fourth title, Spain its second — and could become the first nation to simultaneously hold the World Cup crowns in both men's and women's soccer. Argentina made three changes from its starting 11 for the semifinal win over England : Midfielders Rodrigo De Paul and Nico Gonzalez, along with defender Gonzalo Montiel were in, while midfielders Leandro Paredes and Nahuel Molina, along with forward Giuliano Simeone, were dropped. Spain kept its starting 11 from the semifinal win over France untouched. It's the 104th match of the biggest World Cup ever, a 48-team event that played out over the U.S., Canada and Mexico. Because there were more matches than any previous World Cup, it was no su...",
        "fullText": [
          "EAST RUTHERFORD, N. J.",
          "— Lionel Messi and Argentina on one side. Lamine Yamal and Spain on the other.",
          "The World Cup final is finally here. Kickoff is at 3 p.",
          "m. EDT at MetLife Stadium.",
          "Argentina is seeking its fourth title, Spain its second — and could become the first nation to simultaneously hold the World Cup crowns in both men's and women's soccer. Argentina made three changes from its starting 11 for the semifinal win over England : Midfielders Rodrigo De Paul and Nico Gonzalez, along with defender Gonzalo Montiel were in, while midfielders Leandro Paredes and Nahuel Molina, along with forward Giuliano Simeone, were dropped.",
          "Spain kept its starting 11 from the semifinal win over France untouched. It's the 104th match of the biggest World Cup ever, a 48-team event that played out over the U.",
          "S. , Canada and Mexico.",
          "Because there were more matches than any previous World Cup, it was no su..."
        ],
        "words": [
          "argentina",
          "taking",
      ...
      },
      {
        "category": "Science",
        "source": "KBS World",
        "title": "Heavy Rain, Heat Wave Conditions Expected as Monsoon Season Continues",
        "url": "https://world.kbs.co.kr/service/news_view.htm?lang=e&Seq_Code=202986",
        "summary": "[Science] : Cloudy skies are expected nationwide Sunday, with heavy rainfall of up to 80 millimeters forecast for North Gyeongsang Province later in the day. According to the Korea Meteorological Administration, monsoon rains are expected to continue across much of the country Monday, with up to 60 millimeters ... [more...]",
        "fullText": [
          "[Science] : Cloudy skies are expected nationwide Sunday, with heavy rainfall of up to 80 millimeters forecast for North Gyeongsang Province later in the day. According to the Korea Meteorological Administration, monsoon rains are expected to continue across much of the country Monday, with up to 60 millimeters ...",
          "[more... ]"
        ],
        "words": [
          "conditions",
      ...
      },
      {
        "category": "Domestic",
        "source": "KBS World",
        "title": "About 240 Evacuees Unable to Return Home After Heavy Rains Hit North Gyeongsang",
        "url": "https://world.kbs.co.kr/service/news_view.htm?lang=e&Seq_Code=202985",
        "summary": "[Domestic] : Heavy rains in North Gyeongsang Province forced 420 residents across eight cities and counties to evacuate, with 238 still unable to return home. According to the provincial government, as of 11 a.m. Sunday, 182 of the 420 evacuees had returned, while the remaining residents were staying in temporary ... [more...]",
        "fullText": [
          "[Domestic] : Heavy rains in North Gyeongsang Province forced 420 residents across eight cities and counties to evacuate, with 238 still unable to return home. According to the provincial government, as of 11 a.",
          "m. Sunday, 182 of the 420 evacuees had returned, while the remaining residents were staying in temporary ...",
          "[more... ]"
        ],
        "words": [
          "evacuees",
      ...
      },
      {
        ...
        "source": "KBS World",
        "title": "US Military: 2 US Soldiers Killed by Iran Strikes in Jordan",
        "url": "https://world.kbs.co.kr/service/news_view.htm?lang=e&Seq_Code=202984",
        "summary": "[International] : The United States military reported its first fatalities since Washington resumed attacks on Iran, saying two American soldiers were killed and one remains missing in Jordan. U.S. Central Command said Saturday that the casualties occurred Friday as U.S. forces and allied troops intercepted Iranian ... [more...]",
        "fullText": [
          "[International] : The United States military reported its first fatalities since Washington resumed attacks on Iran, saying two American soldiers were killed and one remains missing in Jordan. U.",
          "S. Central Command said Saturday that the casualties occurred Friday as U.",
          "S. forces and allied troops intercepted Iranian ...",
          "[more... ]"
        ],
        "words": [
          "military",
      ...
      },
      {
        "category": "Domestic",
        "source": "KBS World",
        "title": "Gov't Maintains Level 2 Disaster Response After Heavy Rain",
        "url": "https://world.kbs.co.kr/service/news_view.htm?lang=e&Seq_Code=202983",
        "summary": "[Domestic] : The government said Sunday it will maintain a Level 2 emergency response posture to support recovery efforts and prepare for additional landslides, even though all nationwide heavy rain advisories and warnings have been lifted. The Ministry of the Interior and Safety raised the emergency response posture ... [more...]",
        "fullText": [
          "[Domestic] : The government said Sunday it will maintain a Level 2 emergency response posture to support recovery efforts and prepare for additional landslides, even though all nationwide heavy rain advisories and warnings have been lifted. The Ministry of the Interior and Safety raised the emergency response posture ...",
          "[more... ]"
        ],
        "words": [
          "maintains",
  ...
  },
  {
    ...
    "title": "Korea News Brief",
    "primarySource": "https://world.kbs.co.kr/service/news_main.htm?lang=e",
    "summary": "Today’s Korea news covers Inter-Korea, Weather, Korea, Politics. This free edition uses public news feeds, so it updates without paid API credits.",
    "stories": [
      {
        "category": "Inter-Korea",
        "source": "The Korea Times",
        "title": "Ex-vice Gyeonggi governor found guilty of perjury over claims of 'drinking party' during interrogation",
        "url": "https://www.koreatimes.co.kr/southkorea/politics/20260620/ex-vice-gyeonggi-governor-found-guilty-of-perjury-over-claims-of-drinking-party-during-interrogation?utm_source=rss",
        "summary": "SUWON — A regional court on Saturday found a former vice governor of Gyeonggi Province guilty of perjury for falsely testifying to parliament that he was provided with alcohol and food during a prosecution interrogation. The Suwon District Court sentenced Lee Hwa-young to four months in prison, convicting him of violating the law on testi...",
        "fullText": [
        ...
        "question": "Why does this inter-korea story matter for people living in Korea?"
      },
      {
        "category": "Weather",
        "source": "The Korea Times",
        "title": "Busan brings 'Carmen' to waterfront under summer stars",
        "url": "https://www.koreatimes.co.kr/lifestyle/people-events/20260620/busan-brings-carmen-to-waterfront-under-summer-stars?utm_source=rss",
        "summary": "On a sweeping industrial expanse along Busan’s historic waterfront, workers will soon begin transforming a prominent landmark development site into a massive open-air theater. The production is French composer Georges Bizet's \"Carmen,\" and the backdrop will be the shifting silhouettes of container ships and the night sky over the North Po...",
        "fullText": [
        ...
        "question": "Why does this weather story matter for people living in Korea?"
      },
      {
        "category": "Weather",
        "source": "The Korea Times",
        "title": "Rain to continue nationwide through evening after heavy downpours",
        "url": "https://www.koreatimes.co.kr/southkorea/environment-animals/20260620/rain-to-continue-nationwide-through-evening-after-heavy-downpours?utm_source=rss",
        "summary": "Rain is expected to continue across South Korea through Saturday evening after heavy downpours drenched much of the country overnight, weather officials said. Between 6 p.m. Friday and 6 a.m. Saturday, accumulated precipitation reached 137.5 millimeters on Halla Mountain on Jeju Island, 94 mm in Sangju, 88 mm in Gongju and 60.6 mm in Seou...",
        "fullText": [
      ...
      },
      {
        "category": "Weather",
        "source": "The Korea Times",
        "title": "Midfielder blames S. Korean loss on bad luck",
        "url": "https://www.koreatimes.co.kr/sports/20260620/midfielder-blames-s-korean-loss-on-bad-luck?utm_source=rss",
        "summary": "ZAPOPAN, Mexico — For a fleeting moment during the late stages of South Korea's loss to Mexico at the ongoing FIFA World Cup on Thursday, substitute Eom Ji-sung thought he could become a hero. With South Korea trailing 1-0 in the 87th minute, Eom delivered a cross toward the back post to another sub, Cho Gue-sung. Cho met the ball with hi...",
        "fullText": [
          "ZAPOPAN, Mexico — For a fleeting moment during the late stages of South Korea's loss to Mexico at the ongoing FIFA World Cup on Thursday, substitute Eom Ji-sung thought he could become a hero. With South Korea trailing 1-0 in the 87th minute, Eom delivered a cross toward the back post to another sub, Cho Gue-sung. Cho met the ball with hi...",
          "This story is useful for understanding what people in Korea are talking about today.",
          "For English practice, explain the story in three simple sentences: what happened, who is involved, and why it matters."
        ],
        "words": [
      ...
      },
      {
        "category": "Korea",
        "source": "The Korea Times",
        "title": "BTS' RM named first global ambassador of Nat'l Museum of Korea",
        "url": "https://www.koreatimes.co.kr/lifestyle/people-events/20260620/bts-rm-named-first-global-ambassador-of-natl-museum-of-korea?utm_source=rss",
        "summary": "RM, the leader of K-pop supergroup BTS, has been named the first global ambassador of the National Museum of Korea to help promote the country's cultural heritage around the world, the museum said Saturday. The singer, whose real name is Kim Nam-joon, was named in recognition of his longstanding interest in Korean traditional culture and...",
        "fullText": [
      ...
      },
      {
        "category": "Politics",
        "source": "The Korea Times",
        "title": "LTI Korea chief bets on human translators despite rapid AI development",
        "url": "https://www.koreatimes.co.kr/lifestyle/books/20260620/lti-korea-chief-bets-on-human-translators-despite-rapid-ai-development?utm_source=rss",
        "summary": "As generative artificial intelligence (AI) transforms the global translation landscape, the head of the Literature Translation Institute of Korea (LTI Korea) is making a counterintuitive bet: The future of literary translation will rely not less on humans, but more. “In literature, AI alone cannot meet the level expected by international...",
        "fullText": [
      ...
      },
      {
        "category": "Korea",
        "source": "The Korea Times",
        "title": "Meet the actress quietly powering Netflix's Korean hits",
        "url": "https://www.koreatimes.co.kr/entertainment/shows-dramas/20260620/meet-the-actress-quietly-powering-netflixs-korean-hits?utm_source=rss",
        "summary": "There is one actor who seems to be appearing in nearly every major Netflix hit these days: Lee Sang-hee. Following standout roles in the Netflix original series \"If Wishes Could Kill\" and \"Teach You a Lesson,\" Lee has continued to expand her presence this year through two productions that have captured the attention of viewers around the...",
        "fullText": [
  ...
  },
  {
    ...
    "title": "Korea News Brief",
    "primarySource": "https://world.kbs.co.kr/service/news_main.htm?lang=e",
    "summary": "Today’s Korea news focuses on election oversight, markets, diplomacy, public safety, weather, and data privacy. Officials are digging deeper into the local-election ballot shortage, the KOSPI keeps setting records, Seoul is expanding diplomacy with Europe and the United States, heavy rain is expected in the south, and a major data leak at Tving affected millions of users.",
    "stories": [
      {
        "category": "Politics",
        "source": "KBS World",
        "title": "Fact-Finding Panel Recommends Ballot Shortage Investigations against Ex-NEC Chief, Others",
        "url": "https://world.kbs.co.kr/service/news_view.htm?Seq_Code=202288&id=Po&lang=e",
        "summary": "A fact-finding panel said more investigation is needed over ballot shortages during the recent local elections. The case may lead to closer checks on how election officials prepared and managed voting materials.",
        "fullText": [
          "A fact-finding panel has recommended further investigations into ballot shortages that happened during Korea’s recent local elections. The issue is important because voters expect polling stations to have enough ballots and clear procedures on election day.",
          "The panel said former and current election officials may need to be questioned more closely. Investigators are expected to look at how ballots were prepared, how supplies were checked, and why some places did not have enough voting materials.",
          "For the public, this story is not only about one mistake. It is about trust. If people believe voting was poorly managed, they may start to question the fairness and reliability of the whole election process.",
          "The next step will likely be a closer review by authorities. If problems are confirmed, election offices may face pressure to improve planning, training, and emergency response before future votes."
        ],
        "words": [
          "fact-finding panel",
          "ballot shortage",
        ...
        "question": "Why is careful election management important for public trust?"
      },
      {
        "category": "Economy",
        "source": "KBS World",
        "title": "KOSPI Hits New High above 9,300; Combined Market Cap Surpasses 8 Quadrillion Won",
        "url": "https://world.kbs.co.kr/service/news_view.htm?Seq_Code=202284&lang=e",
        "summary": "Korea’s stock market reached another record as the KOSPI moved above 9,300. The report shows strong investor interest, especially in large listed companies, even while people still watch for global risks.",
        "fullText": [
          "Korea’s KOSPI stock index climbed above 9,300, setting another record high. The total value of listed companies also passed a major milestone, showing strong demand from investors.",
          "A rising stock index often means investors feel confident about large companies and the future of the economy. In Korea, technology and semiconductor companies are especially important because they have a large effect on the market.",
          "However, a record high does not mean every company is doing well. Sometimes a small number of very large companies can lift the whole index while smaller firms remain weak.",
          "For everyday readers, this story is useful because it shows how financial news can sound very positive while still needing careful reading. A good question to ask is: who is benefiting from the rise, and who is not?"
        ],
        "words": [
          "market cap",
          "record high",
        ...
        "question": "What can make stock prices rise even when the global economy feels uncertain?"
      },
      {
        "category": "Diplomacy",
        "source": "Korea JoongAng Daily",
        "title": "Lee, EU leaders condemn North Korea-Russia military cooperation in joint statement",
        "url": "https://www.koreajoongangdaily.com/korea/lee-eu-leaders-condemn-north-korea-russia-military-cooperation-in-joint-statement/12702899",
        "summary": "President Lee Jae Myung and European Union leaders issued a joint statement criticizing military cooperation between North Korea and Russia. They also agreed to widen cooperation in security, trade, energy, and digital policy.",
        "fullText": [
          "President Lee Jae Myung and European Union leaders released a joint statement criticizing military cooperation between North Korea and Russia. The message shows that Korea is trying to work with partners beyond Asia on security issues.",
          "The statement is also connected to wider concerns about North Korea’s weapons development and Russia’s war-related needs. When countries make a joint statement, they are showing that they want to speak with one stronger voice.",
          "The leaders also discussed cooperation in areas such as trade, energy, technology, and digital policy. This means the relationship is not only about security. It is also about economic and industrial cooperation.",
          "For English learners, this story is a good example of diplomatic language. Words like condemn, cooperation, and joint statement are common in international news."
        ],
        "words": [
          "joint statement",
        ...
        "question": "How can strong statements with partners change a country’s diplomatic message?"
      },
      {
        "category": "Foreign Affairs",
        "source": "The Korea Times",
        "title": "Senate confirms Michelle Steel as US ambassador to S. Korea",
        "url": "https://www.koreatimes.co.kr/foreignaffairs/20260618/senate-confirms-michelle-steel-as-us-ambassador-to-korea",
        "summary": "The U.S. Senate confirmed Michelle Steel as ambassador to South Korea. Her arrival matters because Seoul and Washington are coordinating closely on security, trade, and alliance issues.",
        "fullText": [
          "The U.S. Senate confirmed Michelle Steel as the next American ambassador to South Korea. An ambassador is the main official representative of one country in another country.",
          "This appointment matters because South Korea and the United States have a close alliance. They work together on military security, North Korea policy, trade, technology, and regional diplomacy.",
          "A new ambassador can affect how smoothly the two governments communicate. The person may meet Korean officials, explain U.S. policy, listen to Korean concerns, and help manage problems when disagreements appear.",
          "For readers in Korea, this is a useful foreign affairs story because it shows how one appointment can influence a much larger relationship between two countries."
        ],
        "words": [
          "confirm",
          "ambassador",
        ...
        "question": "Why does the appointment of an ambassador matter in relations between two countries?"
      },
      {
        "category": "Weather",
        "source": "KBS World",
        "title": "Heavy Rain Forecast for Jeju, Southern Regions through Saturday",
        "url": "https://world.kbs.co.kr/service/news_view.htm?Seq_Code=202277&id=Sc&lang=e",
        "summary": "Forecasters said rain will start on Jeju and spread to many parts of the country. People in southern areas may need to watch for travel problems and sudden weather changes through Saturday.",
        "fullText": [
          "Weather officials forecast heavy rain for Jeju and southern parts of Korea through Saturday. Rain is expected to begin in Jeju and then spread to other regions.",
          "Heavy rain can affect transportation, outdoor work, flights, ferries, and weekend plans. On islands such as Jeju, weather changes can be especially important because travel depends heavily on airports and ships.",
          "People in affected areas may need to check weather alerts, carry umbrellas, avoid flooded roads, and allow more time for travel. Drivers should also be careful because roads can become slippery or dangerous.",
          "This kind of weather story is practical English. Words like forecast, region, advisory, and through Saturday are common in daily news and public safety information."
        ],
        "words": [
          "forecast",
          "southern regions",
        ...
        "question": "How can heavy rain affect daily life in cities and on islands?"
      },
      {
        "category": "Technology",
        "source": "KBS World",
        "title": "Tving Data Breach Affected over 19 Million People",
        "url": "https://world.kbs.co.kr/service/news_view.htm?Seq_Code=202274&id=Dm&lang=e",
        "summary": "A data breach at streaming platform Tving affected more than 19 million people. The case highlights how important it is for companies to protect personal information and respond clearly after a leak.",
        "fullText": [
          "A data breach at the streaming platform Tving affected more than 19 million people. A data breach means private information was exposed, leaked, or accessed in a way that should not have happened.",
          "The case is serious because streaming services can hold personal details about many users. Depending on the situation, exposed information may include names, contact details, account information, or other private data.",
          "After a major leak, companies are expected to explain what happened, protect affected users, and improve their security systems. Users may also need to change passwords or watch for suspicious messages.",
          "For English learners, technology news often uses words like breach, personal information, platform, and cybersecurity. These words are useful because digital privacy is now a common news topic."
        ],
        "words": [
          "data breach",
        ...
        "question": "What should a company do first after discovering a major data leak?"
      }
    ]
  }
];
